<?php  
    if(!function_exists('cswEnqueueStylesScripts')) {
        function cswEnqueueStylesScripts(){
            ...
            wp_enqueue_script('owlCarouselScript', get_template_directory_uri().'/assets/js/owl.carousel.min.js', array(), '', true);
            wp_enqueue_script('wowJsScript', get_template_directory_uri().'/assets/js/wow.min.js', array(), '', true);
